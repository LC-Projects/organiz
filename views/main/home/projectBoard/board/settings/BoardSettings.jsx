    ...
    return (
        <ScrollView style={[styles.container, backgroundColor ? {backgroundColor:COLORS.dark} : {backgroundColor:COLORS.light}]}>
            ...
            <View style={styles.containerTitle}>
                <TextInput style={styles.name} onChangeText={setTitle}>{data?.title}</TextInput>
            </View>
            ...
            <View style={styles.containerButton}>
                ...
                <TouchableOpacity style={[styles.buttonAction, backgroundColor ? {backgroundColor:COLORS.white} : {backgroundColor:COLORS.green}]} onPress={save}>
